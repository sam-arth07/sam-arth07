...
export default function HeroMobile() {
  ...
  return (
    <div className={`px-6 py-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
      ...
      <div className="mb-10">
        ...
        <p className="text-lg text-[#A9B7C6]">
          <span className="text-[#808080]">// </span>a passionate <span className="text-[#3DDC84]">Android Developer</span>
        </p>
      </div>

      {/* Code snippet style with better spacing */}
      <div className="font-mono text-sm space-y-2 mb-10 bg-[#313335] p-5 rounded-lg border border-[#323232] shadow-lg">
        <p>
      ...
      <div className="flex gap-6 justify-center mt-8">
        <a
          ...
          className="text-[#787878] hover:text-[#3DDC84] transition-all duration-300 transform hover:scale-110"
          aria-label="GitHub"
        >
