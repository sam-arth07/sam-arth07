          ...
          <div className="p-8 font-mono text-sm md:text-base">
            ...
            <div className="mb-12">
              ...
              <div className="mb-8 pl-0">
                <p className="mb-2">
                  <span className="text-[#CC7832]">data class</span> <span className="text-[#A9B7C6]">OpenSourceContribution(</span>
                </p>
                <div className="pl-4">
                  <p><span className="text-[#CC7832]">val</span> <span className="text-[#9876AA]">project</span><span className="text-[#CC7832]">:</span> <span className="text-[#A9B7C6]">String</span> <span className="text-[#CC7832]">=</span> <span className="text-[#6A8759]">"MifosX Android Client"</span><span className="text-[#CC7832]">,</span></p>
                  ...
                  <p><span className="text-[#CC7832]">val</span> <span className="text-[#9876AA]">description</span><span className="text-[#CC7832]">:</span> <span className="text-[#A9B7C6]">String</span> <span className="text-[#CC7832]">=</span> <span className="text-[#6A8759]">"""</span></p>
                  <div className="pl-4 text-[#6A8759]">
                    <p>A comprehensive core banking platform designed for field officers</p>
                    <p>to efficiently process transactions, manage client data, track center</p>
                    <p>records, group details, and handle various types of accounts such as</p>
                    <p>loans, savings, and recurring accounts.</p>
                  </div>
                  <p><span className="text-[#6A8759]">"""</span><span className="text-[#A9B7C6]">.trimIndent()</span><span className="text-[#CC7832]">,</span></p>
                  <p className="mb-2 mt-2"><span className="text-[#CC7832]">val</span> <span className="text-[#9876AA]">contributions</span><span className="text-[#CC7832]">:</span> <span className="text-[#A9B7C6]">List&lt;String&gt;</span> <span className="text-[#CC7832]">=</span> <span className="text-[#A9B7C6]">listOf(</span></p>
                  <div className="pl-4">
                    <p><span className="text-[#6A8759]">"Contributed to core banking platform serving 50K+ active users"</span><span className="text-[#CC7832]">,</span></p>
                    ...
                    <p><span className="text-[#6A8759]">"Enhanced UI/UX following Material Design guidelines"</span><span className="text-[#CC7832]">,</span></p>
                    <p><span className="text-[#6A8759]">"Offline-first architecture enabling financial inclusion in remote areas"</span></p>
                  </div>
            ...
            <div className="mt-8 pt-8 border-t border-[#323232]">
              ...
              >
                ...
                <span className="font-mono">github.com/openMF/android-client</span>
              </a>
            </div>
          </div>
        </div>
