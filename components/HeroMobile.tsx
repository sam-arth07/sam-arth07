...
export default function HeroMobile() {
  ...
  return (
    <div className={`px-6 py-12 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
      ...
      <div className="mb-8">
        ...
        <p className="text-base text-[#A9B7C6]">
          <span className="text-[#808080]">// </span>a passionate <span className="text-[#3DDC84]">Android Developer</span>
        </p>
      </div>

      {/* Code snippet style */}
      <div className="font-mono text-xs space-y-1 mb-8 bg-[#313335] p-4 rounded border border-[#323232]">
        <p>
